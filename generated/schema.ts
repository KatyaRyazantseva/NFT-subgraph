...
export class ExpiryExtended extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ExpiryExtended must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ExpiryExtended", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ExpiryExtended | null {
    return changetype<ExpiryExtended | null>(
      store.get_in_block("ExpiryExtended", id.toHexString())
    );
  }

  static load(id: Bytes): ExpiryExtended | null {
    return changetype<ExpiryExtended | null>(
      store.get("ExpiryExtended", id.toHexString())
    );
  }
...
export class FusesSet extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type FusesSet must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("FusesSet", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): FusesSet | null {
    return changetype<FusesSet | null>(
      store.get_in_block("FusesSet", id.toHexString())
    );
  }

  static load(id: Bytes): FusesSet | null {
    return changetype<FusesSet | null>(store.get("FusesSet", id.toHexString()));
  }
  ...
  set fuses(value: BigInt) {
    this.set("fuses", Value.fromBigInt(value));
  }
...
export class NameUnwrapped extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type NameUnwrapped must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NameUnwrapped", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): NameUnwrapped | null {
    return changetype<NameUnwrapped | null>(
      store.get_in_block("NameUnwrapped", id.toHexString())
    );
  }

  static load(id: Bytes): NameUnwrapped | null {
    return changetype<NameUnwrapped | null>(
      store.get("NameUnwrapped", id.toHexString())
    );
  }
...
export class NameWrapped extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type NameWrapped must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NameWrapped", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): NameWrapped | null {
    return changetype<NameWrapped | null>(
      store.get_in_block("NameWrapped", id.toHexString())
    );
  }

  static load(id: Bytes): NameWrapped | null {
    return changetype<NameWrapped | null>(
      store.get("NameWrapped", id.toHexString())
    );
  }
...
export class TransferSingle extends Entity {
  ...
  get NameWrapper_id(): BigInt {
    let value = this.get("NameWrapper_id");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set NameWrapper_id(value: BigInt) {
    this.set("NameWrapper_id", Value.fromBigInt(value));
  }
