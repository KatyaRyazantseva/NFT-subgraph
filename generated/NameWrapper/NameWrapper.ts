...
export class NameWrapper extends ethereum.SmartContract {
  ...
  canExtendSubnames(node: Bytes, addr: Address): boolean {
    let result = super.call(
      "canExtendSubnames",
      "canExtendSubnames(bytes32,address):(bool)",
  ...
  isWrapped(parentNode: Bytes, labelhash: Bytes): boolean {
    let result = super.call("isWrapped", "isWrapped(bytes32,bytes32):(bool)", [
      ethereum.Value.fromFixedBytes(parentNode),
      ethereum.Value.fromFixedBytes(labelhash)
    ]);
  ...
  try_isWrapped(
    ...
    let result = super.tryCall(
      "isWrapped",
      "isWrapped(bytes32,bytes32):(bool)",
      [
        ethereum.Value.fromFixedBytes(parentNode),
        ethereum.Value.fromFixedBytes(labelhash)
      ]
  ...
  try_isWrapped1(node: Bytes): ethereum.CallResult<boolean> {
  ...
  wrapETH2LD(
    ...
    let result = super.call(
      "wrapETH2LD",
      "wrapETH2LD(string,address,uint16,address):(uint64)",
      [
        ethereum.Value.fromString(label),
        ethereum.Value.fromAddress(wrappedOwner),
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(ownerControlledFuses)),
